...
var GoogleAPI = /** @class */ (function () {
    ...
    GoogleAPI.fetchInterestOverTimeFromGoogle = function (options) {
    ...
    GoogleAPI.fetchInterestByRegionFromGoogle = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var results, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    GoogleAPI.fetchDailyTrendsFromGoogle = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var results, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    GoogleAPI.fetchRealTimeTrendsFromGoogle = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var results, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    GoogleAPI.fetchRelatedQueriesFromGoogle = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var results, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, googleTrends.relatedQueries(options)];
                    case 1:
                        results = _a.sent();
                        if (results)
                            return [2 /*return*/, JSON.parse(results)];
    ...
    GoogleAPI.fetchRelatedTopicsFromGoogle = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var results, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, googleTrends.relatedTopics(options)];
                    case 1:
                        results = _a.sent();
                        if (results)
                            return [2 /*return*/, JSON.parse(results)];
